...
import { FaUsers, FaClipboardList, FaChartBar, FaSignOutAlt, FaCog, FaBox } from "react-icons/fa"; // Added FaBox icon
...
/*import React, { useState, useEffect } from "react";
import { NavLink, Outlet, useNavigate, useLocation } from "react-router-dom";
import { FaUsers, FaClipboardList, FaChartBar, FaSignOutAlt, FaCog } from "react-icons/fa"; // Added FaCog icon
import { onAuthStateChanged } from "firebase/auth";
import { auth } from "../config/firebase";
